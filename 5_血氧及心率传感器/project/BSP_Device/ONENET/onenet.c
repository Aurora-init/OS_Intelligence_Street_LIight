...
_Bool OneNet_DevLink(void)
{
	...
	if(MQTT_PacketConnect(PROID, AUTH_INFO, DEVID, 256, 0, MQTT_QOS_LEVEL0, NULL, NULL, 0, &mqttPacket) == 0)
	{
		...
		if(dataPtr != NULL)
		{
			...
			if(MQTT_UnPacketRecv(dataPtr) == MQTT_PKT_CONNACK)
			{
				...
				{
					case 0:	UsartPrintf(&huart1, "\r\nTips:	连接成功\r\n");status = 0;								break;
					case 1:	UsartPrintf(&huart1, "\r\nWARN:	连接失败：协议错误\r\n");									break;
					case 2:	UsartPrintf(&huart1, "\r\nWARN:	连接失败：非法的clientid\r\n");						break;
					case 3:	UsartPrintf(&huart1, "\r\nWARN:	连接失败：服务器失败\r\n");								break;
					case 4:	UsartPrintf(&huart1, "\r\nWARN:	连接失败：用户名或密码错误\r\n");					break;
					case 5:	UsartPrintf(&huart1, "\r\nWARN:	连接失败：非法链接(比如token非法)\r\n");	break;
					default:UsartPrintf(&huart1, "\r\nERR:	连接失败：未知错误\r\n");									break;
				}
			}
		}
	...
	{	
		UsartPrintf(&huart1, "\r\n平台无响应\r\n");
		UsartPrintf(&huart1, "\r\nWARN:	MQTT_PacketConnect Failed\r\n");
	}
	return status;
}
